%% ery_4a_masks_m6_s0_taste_cortex_R_mask_from_atlas.m
%
% This script creates a Right side taste cortex mask by combining regions from one or more
...
%
%__________________________________________________________________________
% @(#)% LaBGAScore_atlas_taste_cortex_R_mask_from_atlas.m         v1.2       
...
maskname = 'ery_4a_m6_mask_taste_cortex_R';
...
%--------------------------------------------------------------------------
canlab_subset = select_atlas_subset(canlab, {'Ctx_AVI_R','Ctx_AAIC_R','Ctx_MI_R','Ctx_FOP3_R','Ctx_FOP2_R'});
