...
[~,modelname_first] = fileparts(DSGN.modelingfilesdir);
...
datadir = fullfile(rootdir,'firstlevel',modelname_first); %lukasvo76: contrary to the original CANlab script, we want to keep firstlevel data in the model-specific dir of the firstlevel subdataset
