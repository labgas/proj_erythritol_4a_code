%% ery_4a_secondlevel_m6m_s6g_prep_3a_run_2nd_lvl_parcreg_cov_hun.m
%
%
% USAGE
%
...
results_suffix = 'cov_hun'; % adds a suffix of your choice to .mat file with results that will be saved
...
covs2use = {'hunger'}; % needs to correspond to variable name(s) in DAT.BETWEENPERSON.(mygroupnamefield){:} AND THE ORDER IN WHICH THEY APPEAR THERE
...
for c = 1:kc
    ...
    switch design_matrix_type
        ...
        case 'custom'
            ...
            table_obj = DAT.BEHAVIOR.behavioral_data_table; % lines edited since hunger is a subject-level covariate
            groupnames = covs2use;
            X = table_obj.(groupnames{1});
