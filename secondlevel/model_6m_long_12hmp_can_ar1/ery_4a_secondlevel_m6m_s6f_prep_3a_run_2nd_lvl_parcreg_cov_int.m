%% ery_4a_secondlevel_m6m_s6f_prep_3a_run_2nd_lvl_parcreg_cov_int.m
%
%
% USAGE
%
...
results_suffix = 'cov_int'; % adds a suffix of your choice to .mat file with results that will be saved
...
switch mygroupnamefield
    ...
    case 'contrasts'
        ...
        kc = size(DAT.contrasts, 1) - 3; % we exclude the last three contrasts here, as water does not have intensity ratings
