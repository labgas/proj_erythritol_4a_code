...
% list of models
mod_nams = {'model_1_conds_pmods' 'model_6_long_12hmp_can_ar1'}; % study-specific: we want to compare model 1, which is the preregistered model with pmods, with model 6, which is the same model without pmods
