%%% ery_4a_firstlevel_m18_s2_fit_model.m
%
...
% check whether ery_4a_firstlevel_m18_s1_options_dsgn_struct has been run

if ~exist('DSGN','var')
    warning('\nDSGN structure variable not found in Matlab workspace, running ery_4a_firstlevel_m18_s1_options_dsgn_struct before proceeding')
    ery_4a_firstlevel_m18_s1_options_dsgn_struct;
    cd(rootdir);
else
    cd(rootdir);
end
