...
% INPUT
    ...
    DSGN.modeldir = '/data/test_second_level_scripts/firstlevel/model_11_short_12hmp_can_deriv_noar1'; % directory where you want to write first level results for this model
