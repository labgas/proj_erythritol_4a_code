%%% ery_4a_firstlevel_m10_s1_options_dsgn_struct.m
%
...
% INPUT
    ...
    % REQUIRED FIELDS
    DSGN.metadata = "proj-erythritol_4a first level analysis model 10, i.e. modeling 4 conditions for sucrose, erythritol, sucralose, and water as long events (= duration of solution in mouth), with 12 hmp, canonical hrf with derivatives, without ar(1)"; % field for annotation with study info, or whatever you like
    DSGN.modeldir = '/data/proj_erythritol/proj_erythritol_4a/firstlevel/model_10_long_12hmp_can_deriv_noar1'; % directory where you want to write first level results for this model
...
%     DSGN.singletrialsall = false; % default: false; if true, set DSGN.singletrials to true for all conditions
    DSGN.modelingfilesdir = 'model_10_long_12hmp_can_deriv_noar1'; % name of subfolder which will be created within directory containing functional files where .mat files containing fields of DSGN structure will be saved; typically same as the last part of the path of DSGN.modeldir
