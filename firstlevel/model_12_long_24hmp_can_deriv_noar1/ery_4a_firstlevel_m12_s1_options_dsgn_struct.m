...
% INPUT
    ...
    DSGN.modeldir = '/data/test_second_level_scripts/firstlevel/model_12_long_24hmp_can_deriv_noar1'; % directory where you want to write first level results for this model
