%% ery_4a_m6r_s4a_mask_cosmomvpa_searchlight_rsa_euclid.m
%
%
% *USAGE*
%
...
%                                       distance metric used for behavioral
%                                       and neural dissimilarity matrices
%
...
results_suffix = 'all_conds_euclid';
...
for sub = 1:firstsub
    ...
    switch analysis_level
        ...
        case 'run'
            ...
            dsm_behav_vect_runs = cosmo_pdist(behav_runs', distance_metric);
            dsm_behav_mat_runs = cosmo_squareform(dsm_behav_vect_runs');

            figure;
            heatmap(dsm_behav_mat_runs, 'Colormap', jet);
            figtitle = [firstsubjs{sub} ' dissimilarity matrix (' distance_metric ')'];
            set(gca,'Title',figtitle);
            set(gcf,'WindowState','maximized');
            drawnow, snapnow;
    ...
    measure_args = struct();
    measure_args.metric = distance_metric;
    
    if strcmpi(distance_metric,'correlation')
